...
import com.greenhalolabs.emailautocompletetextview.util.*;
...
//            	int width = mTappableDrawable.getIntrinsicWidth();
//            	int height = mTappableDrawable.getIntrinsicHeight();
